 ...
 * @subpackage Example
 * @version    2.6.1 for child theme imaginet for publication on WordPress.org
 ...
 */
require_once get_stylesheet_directory() . '/functions/tgm//class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'imaginet_register_required_plugins' );
...
function imaginet_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => get_template_directory() . '/functions/tgm/plugins/revslider.zip', // The plugin source.
			'required'           => false,
		),
		array(
			'name'	   => 'Contact Form 7',
		...
		array(
			'name'	   => 'Accessible Poetry',
			'slug'	   => 'accessible-poetry',
			'required' => false,
		),
		array(
