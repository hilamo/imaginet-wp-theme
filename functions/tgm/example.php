 ...
 * @subpackage Example
 * @version    2.6.1 for child theme imaginet_ for publication on WordPress.org
...
add_action( 'tgmpa_register', 'imaginet__register_required_plugins' );
 ...
 */
function imaginet__register_required_plugins() {
	/*
